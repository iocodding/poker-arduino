...
<template>
  <article
    class="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden"
  >
    <!-- Image -->
    <!-- <router-link
    ...
    <!-- <img
      ...
      src="https://wire-elements.dev/img/modal.png"
      width="220"
      height="236"
      alt="Meetup 01"
    /> -->
    ...
    <div class="grow p-5 flex flex-col">
      ...
      <div class="flex justify-between mt-3">
        <!-- Tag -->
        <div
          class="text-xs inline-flex items-center font-medium bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400 rounded-full text-center px-2.5 py-1"
        >
          <svg
            class="w-4 h-3 fill-slate-400 dark:fill-slate-500 mr-2"
            viewBox="0 0 16 12"
          >
            <path
